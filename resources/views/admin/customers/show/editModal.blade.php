<!-- Modal -->
<!-- Edit User Modal -->
<div class="modal fade" id="editUser{{$customer->id}}" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-simple modal-edit-user">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <form id="editUserForm" class="row g-3" action="{{ route('customers.update', $customer->id) }}" method="POST" enctype="multipart/form-data">
            {{ method_field('patch') }}
            {{ csrf_field() }}
            ...
            <div class="col-12 col-md-6">
                <label class="form-label" for="verified">Verified</label><br>
                <label class="switch switch-success switch-lg">
                    <input type="checkbox" name="verified" class="switch-input" <?php echo ($customer->verified ? 'checked' : ''); ?>>
